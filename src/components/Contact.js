...
const notify = () => toast.success('Thanks! Your message has been received.', {
      ...
      <div className='container mx-auto'>
        ...
        >
          ...
          >
            ...
            ></textarea>
            <button type="button" onClick={notify} className='btn btn-lg bg-accent hover:bg-secondary-hover'>
              Send message
            </button>
            <Toaster />
          </form>
